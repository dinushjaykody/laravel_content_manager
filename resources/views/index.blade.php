                ...
                <div class="col-lg-12">
                    <div class="offers">
                        <div class="row">
                            <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
                                <div class="heading">
                                    <h4 class="h1 heading-title">{{$computers->name}}</h4>
                        ...
                        <div class="row">
                            <div class="case-item-wrap">
                                @foreach($computers->posts()->orderBy('created_at', 'desc')->take(3)->get() as $post)
                    ...
                    <div class="offers">
                        <div class="row">
                            <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
                                <div class="heading">
                                    <h4 class="h1 heading-title">{{$entertainment->name}}</h4>
                                    <div class="heading-line">
                                        <span class="short-line"></span>
                                        <span class="long-line"></span>
                                    </div>
    ...
    <div class="container">
        <div class="row">
            <div class="form_search-wrap">
                <form method="POST" action="{{route('post.results')}}" >
                    {{csrf_field()}}
